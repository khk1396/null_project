<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com._null.semi_box.model.vo.Product, java.util.ArrayList" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	<main class="market-page contents-container all-users-trade page-layout footer-fixed-bottom">
	    <div class="market-page contents-inner all-users-trade" >
	        ...
	        <div class="market-page item-list-container all-users-trade">
	            ...
	            <form action="tradeRegist" method="post" onclick="this.submit();" class="market-page product-item container card box-shadow all-users-trade">
	            	...
	            	<div class="market-page product-item card img-container all-users-trade" >
		                <img class="market-page product-item card img all-users-trade" src="<%= productList.get(i).getProductImg() %>" />	            	
	            	</div>
