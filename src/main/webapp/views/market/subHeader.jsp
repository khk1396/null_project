...
<body>
	...
	<div class="market-page sub-header-container" >
		<div class="market-page sub-header-inner page-layout" >
	        <a href="${ pageContext.request.contextPath }/market" class="market-page link link-medium link-text-hover" >전체 상품</a>
	        <a href="${ pageContext.request.contextPath }/market/myRegistedProducts" class="market-page link link-medium link-text-hover">나의 등록 상품</a>
	        <a href="${ pageContext.request.contextPath }/market/myAppliedProducts" class="market-page link link-medium link-text-hover">나의 거래 요청</a>
	        <a href="${ pageContext.request.contextPath }/market/tradeRegist" class="market-page link link-medium link-text-hover" >상품 등록</a>
	        <a href="${ pageContext.request.contextPath }/market/tradeHistory" class="market-page link link-medium link-text-hover" >상품 교환 내역</a>		
		</div>
    </div>
</body>
</html>