			...
			<div class="shop-page payament payment-details-container">
				...
				<div class="shop-page payment payment-option-container">
					...
					<label class="shop-page payment payment-option label">
						<input class="shop-page payment payment-option radio" type="radio" name="payment" value="계좌이체">
						<div class="shop-page payment payment-option value" >계좌 이체</div>
					</label>
					<label class="shop-page payment payment-option label">
						<input class="shop-page payment payment-option radio" type="radio" name="payment" value="간편결제">
						<div class="shop-page payment payment-option value" >간편 결제</div>
					</label> 
					<label class="shop-page payment payment-option label">
						<input class="shop-page payment payment-option radio" type="radio" name="payment" value="카드결제">
					...
					<div class="shop-page payment btn-container" >
						...
						<form action="${pageContext.request.contextPath}/shop/paymentResult" method="post">
							<input type="hidden" name="boxCode" value="${semiBoxVo.boxCode}">
